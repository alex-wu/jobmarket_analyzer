...
What the project knows it hasn't solved yet. ADRs in [DECISIONS.md](../DECISIONS.md) record locked decisions; this file tracks the loose ends. When an item closes, it moves to **Resolved** with a pointer to the ADR or changelog entry that closed it.
