...
- **Role/title filter is skills-page-local** (ADR-026) — deliberately not in filterCard and not URL-persisted. Revisit only if cross-page title analysis becomes a real workflow.
