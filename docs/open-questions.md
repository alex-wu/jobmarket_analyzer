...
- **Dashboard surface for `work_arrangement`** — `site/src/data/postings.parquet.js:25-44` projection does NOT include the new column yet. Add it + a chart slot (likely on `index.md` or a new "dynamics" page). Trivial.
